...
public class GpTest3 {
    ...
    {
        IMap m = new Map();
        GameManager gm = new GameManager(2,"r,r");
        int expected_armies = gm.calculateInitialArmies();
    ...
    {
        IMap m = new Map();
        GameManager gm = new GameManager(4,"r,r,r,r");
        int expected_armies = gm.calculateInitialArmies();
    ...
    {
        IMap m = new Map();
        GameManager gm = new GameManager(5,"r,r,r,r,r");
        int expected_armies = gm.calculateInitialArmies();
    ...
    {
        IMap m = new Map();
        GameManager gm = new GameManager(6, "r,r,r,r,r,r");
        int expected_armies = gm.calculateInitialArmies();
